 ...
 *
 */
public class LiftToRocketPosition extends Command {

	public LiftToRocketPosition() {
    ...
    protected void initialize() {
        Constants.liftRocketPositionPidSetpoint = SmartDashboard.getNumber("Lift Rocket PID Setpoint", Constants.liftRocketPositionPidSetpoint);
    ...
    protected boolean isFinished() {
    	if ((isTimedOut()) || 
    		((Math.abs(Robot._liftMotor.getEncoderCount() - Constants.liftRocketPositionPidSetpoint))
